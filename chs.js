...
var cnItems = {
    ...
    "SAT +5, HP +5, Gluttony EXP Gain +3%, New Title": "能量 +5，生命值 +5，暴食经验增益 + 3%，新称号",
    "Pain Resistance": "抗痛性",
    "Meditation": "冥想",
    ...
    "You've been all skin and bones as long as you can remember. You will need to start eating properly if you wish to survive": "从你记事起，你就一直是皮包骨头。如果你想生存，你需要开始正确饮食",
    "\"Garbage Eater\"": "\"垃圾吞噬者\"",
    "\"Prick\"": "\“刺\”",
    "\"Stick Kid\"": "\“棍棒小子\”",
    "\"Weakling\"": "\"弱者\"",
    ...
    "You really like sleeping don't you? You spend a lot of time in your bed": "你真的很喜欢睡觉不是吗？ 你花了很多时间在床上",
    ...
    "Spearholder": "持矛者",
    "Trained Civilian": "受过训练的平民",
    "You begin to gain some weight eating all this boring and dry food. But you're not complaining, at least you live": "吃了所有这些枯燥乏味的食物，你的体重开始增加。 但你没有抱怨，至少你还活着",
    ...
    "7%, Pain Resistance EXP Gain +10%, Gluttony EXP Gain +10%, New Title": "7%，抗痛经验增益 +10%，暴食经验增益 +10%，新称号",
    "8, SAT +6": "8, 能量 +6",
    "'Greed'": "'贪婪'",
    "'Trading'": "'贸易'",
    ...
    ", New Title": ", 新称号",
    "10, Death EXP Gain +5%, Gluttony EXP Gain +7%": "10、死亡经验获得+5%，暴食经验获得+7%",
    ...
    "You learned to sleep very soundly, without any care for the outside world. Your body begins to adapt and grow stronger with every break you take": "你学会了睡得很香，完全不关心外面的世界。 每休息一次，您的身体就会开始适应并变得更强壮",
    ...
    "Energy Consumtion +0.2": "能源消耗 +0.2",
    "Fighter": "战斗机",
    "Firewood Pile": "木柴堆",
